...
public class EmployeeDTO {
	...
	// 전체 생성자를 활용, jpaMapper를 호출해서 맵핑해준다.
	public EmployeeDTO(Integer emp_no, Date birth_no, 
			String first_name, String last_name, 
			Character gender, Date hire_date, BigInteger age) {
		super();
